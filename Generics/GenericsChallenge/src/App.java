// Challenge
// create a generic class to create a league table for a sport
// the class should allow teams to be added to the list and store a list of teams that belong to the league 

// should have a method to print out the teams in order, with the team at the top of the league printed first 
