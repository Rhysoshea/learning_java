...
// - has 3 protected fields, two ListItems called rightLink and leftLink and an object called value
// - a constructor that takes an object and initialises the field value with the parameter that was passed in 
// - 7 methods, next(), setNext(), previous(), setPrevious(), compareTo() which are package-private and abstract 
